...
import numpy as np
import random
from neural_network_for_lower import NeuralNetwork_for_lower
...
class DQN_lower:
    # hyper params
    def __init__(self,
                 n_actions=NeuralNetwork_for_lower().output_ports,
                 n_features=NeuralNetwork_for_lower().input_ports,
    ...
    def _built_net(self):
        tar_nn = NeuralNetwork_for_lower()
        eval_nn = NeuralNetwork_for_lower()
